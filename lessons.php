    ...
    <div class="lessons-section">
        ...
        <div class="lessons-container">
            <div class="lessons-items">
                ...
                <button><a href="linux.php">Leçons</a></button>
            </div>
            <div class="lessons-items">
                <img src="img/sql.png"/>
                <h3>SQL</h3>
                ...
                <button><a href="sql.php">Leçons</a></button>
            </div>
            <div class="lessons-items">
                ...
                <button><a href="code.php">Leçons</a></button>
            </div>
            <div class="lessons-items">
                <img src="img/cms.png"/>
                <h3>CMS</h3>
                ...
                <button><a href="cms.php">Leçons</a></button>
            </div>
            <div class="lessons-items">
                ...
                <button><a href="docker.php">Leçons</a></button>
            </div>
            <div class="lessons-items">
                ...
                <button><a href="devops.php">Leçons</a></button>
            </div>
            <div class="lessons-items">
                ...
                <button><a href="bash.php">Leçons</a></button>
            </div>
        </div>
    </div>
