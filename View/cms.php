    ...
    <div class="lessons-section">
        ...
        <div class="lessons-container">
            <div class="lessons-items">
                ...
                <p>Un CMS (content management system) ousystème de gestion de contenu en français, est une application logicielle qui fonctionne dans un navigateur. Cette leçon t'aidera à mieux le comprendre.</p>
